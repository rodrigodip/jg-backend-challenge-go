> **REQUISITOS.md — definição de pronto deste projeto.** Enunciado original do
> desafio (antes em `README.md`, restaurado verbatim de `a97ac55`); não editar.
> A solução entregue está documentada em `README.md`.
>
